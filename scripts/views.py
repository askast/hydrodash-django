...
def getVarSpeedCoeffs(request):
    ...
    var_speed_trims = {
        ...
        "KV4013D_1800":[10.1, 11, 11.35, 12.5, 13.5],
...
def populatePumps(request):
    pump_str = [
        # ["CI", 1209,"C", 1160,[6.7,7.4,8.1,8.8,9.5]],
        # ["CI", 1511,"B", 1160,[8.25,9,9.75,10.5,11.25]],
        # ["CI", 2510,"C", 1160,[7,7.75,8.5,9.25,10]],
        # ["CI", 4011,"C", 1160,[8,8.75,9.5,10.25,11]],
        # ["CI", 1209,"C", 1760,[6.7,7.4,8.1,8.8,9.5]],
        # ["CI", 1209,"C", 3500,[6.7,7.4,8.1,8.8,9.5]],
        # ["CI", 1511,"B", 1760,[8.25,9,9.75,10.5,11.25]],
        # ["CI", 2510,"C", 1760,[7,7.75,8.5,9.25,10]],
        # ["CI", 4011,"C", 1760,[8,8.75,9.5,10.25,11]],
        # ["FI", 1209,"C", 1160,[6.7,7.4,8.1,8.8,9.5]],
        # ["FI", 1511,"B", 1160,[8.25,9,9.75,10.5,11.25]],
        # ["FI", 2510,"C", 1160,[7,7.75,8.5,9.25,10]],
        # ["FI", 4011,"C", 1160,[8,8.75,9.5,10.25,11]],
        # ["FI", 1209,"C", 1760,[6.7,7.4,8.1,8.8,9.5]],
        # ["FI", 1209,"C", 3500,[6.7,7.4,8.1,8.8,9.5]],
        # ["FI", 1511,"B", 1760,[8.25,9,9.75,10.5,11.25]],
        # ["FI", 2510,"C", 1760,[7,7.75,8.5,9.25,10]],
        # ["FI", 4011,"C", 1760,[8,8.75,9.5,10.25,11]],
        # ["KV", 1509,"A", 1160,[6.5,7.25,8,8.75,9.5]],
        # ["KS", 1509,"A", 1760,[6.5,7.25,8,8.75,9.5]],
        # ["KV", 1509,"A", 1760,[6.5,7.25,8,8.75,9.5]],
        # ["KV", 1509,"A", 3500,[6.5,7.25,8,8.75,9.5]],
        # ["KS", 1509,"A", 1160,[6.5,7.25,8,8.75,9.5]],
        # ["KS", 1509,"A", 3500,[6.5,7.25,8,8.75,9.5]],
        # ["KV", 2011,"A", 1160,[8.25,9,9.75,10.5,11.25]],
        # ["KS", 2011,"A", 1160,[8.25,9,9.75,10.5,11.25]],
        # ["KV", 2011,"A", 1760,[8.25,9,9.75,10.5,11.25]],
        # ["KS", 2011,"A", 1760,[8.25,9,9.75,10.5,11.25]],
        # ["KS", 8016,"A", 1160,[11.5,12.75,14,15,16.5]],
        # ["KS", 8016,"A", 1760,[11.5,12.75,14,15,16.5]],
        # ["KS", 1013,"A", 1160,[9.5,10.375,11.25,12.125,13]],
        # ["KS", 1013,"A", 1760,[9.5,10.375,11.25,12.125,13]],
        # ["KS", 1016,"A", 1160,[11.5,12.625,13.75,14.875,16]],
        # ["KS", 1016,"A", 1760,[11.5,12.625,13.75,14.875,16]],
        # ["KS", 1213,"B", 1160,[9.5,10.375,11.25,12.125,13]],
        # ["KS", 1213,"B", 1760,[9.5,10.375,11.25,12.125,13]],
        # ["KS", 1217,"A", 1160,[13.5,14.5,15.5,16.5,17.3]],
        # ["KS", 1217,"A", 1760,[13.5,14.5,15.5,16.5,17.3]]
    ]
